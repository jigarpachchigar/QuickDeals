...
public class QdSortProdAdapter extends BaseExpandableListAdapter {
    ...
    public QdSortProdAdapter(Context context, List<String> listDataHeader,
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if (convertView == null) {
            ...
            convertView = infalInflater.inflate(R.layout.qdeals_sort_prod_list, null);
        }
