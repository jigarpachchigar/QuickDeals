...
public class QdProdSortAdapter extends BaseAdapter {

    private LayoutInflater inflater;
    private String[] sortBy;
    private int selectedId;

    public QdProdSortAdapter(Context context, String[] sortBy, int selectedId) {
        this.sortBy = sortBy;
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        rowView = inflater.inflate(R.layout.qdeals_sort_prod_list, null);
