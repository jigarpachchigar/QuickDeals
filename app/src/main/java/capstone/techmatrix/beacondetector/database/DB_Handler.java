...
public class DB_Handler extends SQLiteOpenHelper {
    ...
    public void insertCategories(int id, String name) {
        ...
        String selectQuery = "SELECT * FROM " + QDCategories + " WHERE " + ID + "=?";
        ...
        if (isUpdate) {
            db.update(QDCategories, values, ID + " = ?",
                    new String[]{String.valueOf(id)});
        } else {
            db.insert(QDCategories, null, values);
        }
        db.close();
    }
    ...
    public void insertProducts(int id, int cat_id, String name, String date, String tax_name, Double tax_value) {
        ...
        // Check If Value Already Exists
        boolean isUpdate = false;
        String selectQuery = "SELECT * FROM " + QDProdcuts + " WHERE " + ID + "=?";
        Cursor cursor = db.rawQuery(selectQuery, new String[]{String.valueOf(id)});
        if (cursor.moveToFirst()) {
            isUpdate = true;
        }
        ...
        if (isUpdate) {
            db.update(QDProdcuts, values, ID + " = ?",
                    new String[]{String.valueOf(id)});
            db.close();
            return;
        }
        ...
        db.insert(QDProdcuts, null, values);
        db.close();
    }
    ...
    public void insertVariants(int id, String size, String color, String price, int product_id) {
        ...
        // Check If Value Already Exists
        boolean isUpdate = false;
        String selectQuery = "SELECT * FROM " + QDVar + " WHERE " + ID + "=?";
        Cursor cursor = db.rawQuery(selectQuery, new String[]{String.valueOf(id)});
        if (cursor.moveToFirst()) {
            isUpdate = true;
        }
        ...
        if (isUpdate) {
            db.update(QDVar, values, ID + " = ?",
                    new String[]{String.valueOf(id)});
        } else {
            db.insert(QDVar, null, values);
        }
    ...
    public void insertChildCategoryMapping(int category_id, int child_id) {
        ...
        boolean isUpdate = false;
        int id = 0;
        String selectQuery = "SELECT * FROM " + QDSubCategories + " WHERE " + CAT_ID + "=? AND " + SUB_ID + "=?";
        ...
        if (isUpdate) {
            db.update(QDSubCategories, values, ID + " = ?",
                    new String[]{String.valueOf(id)});
        } else {
            db.insert(QDSubCategories, null, values);
        }
    ...
    // Get QdProducts List By Selected Filters
    public List<Product> getProductsList(int sortById, List<String> sizes, List<String> colors, int cat_id, String email) {
        ...
        String selectQuery = "SELECT DISTINCT " + PDT_ID + " FROM " + QDVar;
        try {
            if (sizes.size() > 0) {
        ...
        try {
            if (productIdList.size() > 0) {
                ...
                selectQuery = "SELECT  * FROM " + QDProdcuts + " WHERE " + ID + " IN " + inClause;
                if (cat_id > 0) {
    ...
    public List<Category> getCategoryList() {
        ...
        // Select All Query
        String selectQuery = "SELECT * FROM " + QDCategories;
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                String selectCategory = "SELECT  * FROM " + QDSubCategories + " WHERE " + SUB_ID + "=?";
    ...
    public List<Category> getSubcategoryList(int id) {
        ...
        // Select QdProdSubCategory
        String selectQuery = "SELECT  " + SUB_ID + " FROM " + QDSubCategories + " WHERE " + CAT_ID + "=?";
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                String selectSubCategory = "SELECT  " + NAME + " FROM " + QDCategories + " WHERE " + ID + "= ?";
    ...
    /*// Get QdProducts List By Category
    ...
    public List<String> getSizeByProductId(int id) {
        ...
        // Select All Query
        String selectQuery = "SELECT DISTINCT " + SIZE + " FROM " + QDVar + " WHERE " + PDT_ID + "=?";
    ...
    public List<String> getColorBySelectedSize(int id, String size) {
        ...
        // Select All Query
        String selectQuery = "SELECT DISTINCT " + COLOR + " FROM " + QDVar + " WHERE " + PDT_ID + "=? AND " + SIZE + "=?";
    ...
    public List<String> getProductColorsById(int id) {
        ...
        // Select All Query
        String selectQuery = "SELECT DISTINCT " + COLOR + " FROM " + QDVar + " WHERE " + PDT_ID + "=?";
    ...
    public String getProductPriceRangeById(int id) {
        ...
        // Select All Query
        String selectQuery = "SELECT DISTINCT " + PRICE + " FROM " + QDVar + " WHERE " + PDT_ID + "=?";
        ...
        if (minimumPrice == maximumPrice) {
            return "CAD " + Util.formatDouble(maximumPrice);
        } else {
            return "CAD " + Util.formatDouble(minimumPrice) + " - CAD " + Util.formatDouble(maximumPrice);
        }
    }
    ...
    public Variant getProductVariant(int id, String size, String color) {
        ...
        if (size == null) {
            selectQuery = "SELECT * FROM " + QDVar + " WHERE " + PDT_ID + "=? AND " + COLOR + "=?";
            cursor = db.rawQuery(selectQuery, new String[]{String.valueOf(id), color});
        } else {
            selectQuery = "SELECT * FROM " + QDVar + " WHERE " + PDT_ID + "=? AND " + SIZE + "=? AND " + COLOR + "=?";
        ...
        if (cursor.moveToFirst()) {
            ...
            priceString = Util.formatDouble(price);
    ...
    public List<String> getAllColors() {
        ...
        // Select Query
        String selectQuery = "SELECT DISTINCT " + COLOR + " FROM " + QDVar;
    ...
    public List<String> getAllSizes() {
        ...
        // Select Query
        String selectQuery = "SELECT DISTINCT " + SIZE + " FROM " + QDVar;
    ...
    public long registerUser(String name, String email, String mobile, String password) {
        ...
        return db.insert(QDUsers, null, values);
    }
    ...
    public User getUser(String email) {
        ...
        // Select Query
        String selectQuery = "SELECT * FROM " + QDUsers + " WHERE " + EMAIL + "=?";
    ...
    public long insertIntoCart(int pdt_id, int var_id, int quantity, String email) {
        ...
        // Check If Value Already Exists
        String selectQuery = "SELECT * FROM " + QDUserCart + " WHERE " + EMAIL + "=? AND " + PDT_ID + "=? AND " + VAR_ID + "=?";
        ...
        cursor.close();
        return db.insert(QDUserCart, null, values);
    }
    ...
    public List<Cart> getCartItems(String email) {
        ...
        // Select All Query
        String selectQuery = "SELECT  * FROM " + QDUserCart + " WHERE " + EMAIL + "=?";
